...
create table community (
    ...
    voice_region varchar not null,
    creator_id bigint not null,
    deleted boolean not null
);
--rollback drop table if exists community;

create index ix_community__creator_id on community (creator_id);
--rollback drop index concurrently if exists ix_community__creator_id;
...
create index ix_membership__community_id on membership (community_id);
--rollback drop index concurrently if exists ix_membership__community_id;

create index ix_membership__user_id on membership (user_id);
...
create index ix_membership_role__membership_id on membership_role (membership_id);
--rollback drop index concurrently if exists ix_membership_role__membership_id;
